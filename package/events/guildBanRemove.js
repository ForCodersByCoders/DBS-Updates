...
const guildBanRemove = async (client, guild, user) => {

    client.unBanned.map(async command => {
        ...
        if (!channel) return console.error(`Missing or incorrect channel: UnbanCommand[${name}]`)
